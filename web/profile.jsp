                                ...
                                <div class="tab-content">
                                        ...
                                        <form class="form-horizontal" action="ChangePassword" method="post">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i class="fa fa-key"></i></span>
                                                        <input type="password" class="form-control" id= "re_pass"placeholder="Repeat Password" name="reNewPass">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="settings">
                                        <form class="form-horizontal" action="setting" method="post">
                                            <div class="form-group">
                                                <label for="edu" class="col-sm-2 control-label">Name</label>

                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="edu" placeholder="Name" name="name">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="loc" class="col-sm-2 control-label">Phone Number</label>

                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="loc" placeholder="Phone Number" name="phone">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="bio" class="col-sm-2 control-label">Email</label>

                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" id="bio" placeholder="Email" name="email">
                                                </div>
                                            </div>
                                            <div class="form-group">
